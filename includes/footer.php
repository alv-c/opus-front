<footer>
                    ...
                    <div class="row no-margin-padding">
                        <div class="col-md-6 col-sm-6 col-12 no-margin-padding">
                            <div class="left-top">
                                ...
                                <span class="desc">62 3250-0400</span>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-12 no-margin-padding">
                            <div class="left-top">
                    ...
                    <div class="row no-margin-padding linha-right-top">
                        ...
                        <div class="col-md-4 col-sm-12 no-margin-padding coluna-right-top">
                            <div class="right-top">
                                <span class="titulo">Central de relacionamento</span>
                                <div class="contain-btns">
                                    <a href="#" class="item">Portal do Cliente</a>
                                    <a href="#" class="item">Financiamento</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 no-margin-padding coluna-right-top">
                            <div class="right-top">
                                <span class="titulo">Central de relacionamento</span>
                                <div class="contain-btns">
                                    <a href="#" class="item">Central de relacionamento</a>
                                    <a href="#" class="item">Vendas</a>
                                    <a href="#" class="item">Seja um fornecedor</a>
                                    <a href="#" class="item">Vender um terreno</a>
                                    <a href="#" class="item">Marketing</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row no-margin-padding">
                <div class="col-lg-8 col-md-12 col-sm-12 no-margin-padding">
                    <div class="row no-margin-padding linha-left-bottom">
                        ...
                        <div class="col-md-3 col-sm-6 col-6 no-margin-padding coluna-left-bottom">
                            <div class="left-bottom">
                                <span class="titulo">SHOWROOM VACA BRAVA</span>
                                <span class="desc">Avenida T-15, 319, Setor Bueno. Goiânia - GO - 74230-010</span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-6 no-margin-padding coluna-left-bottom">
                            <div class="left-bottom">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // CARROSSEL SESSAO "GALERIA" PAGINA IMOVEL.PHP
            $('.btn-next-carrossel-2').click(function() {
                $(".slider-main-2").slick('slickNext');
            });

            $('.btn-prev-carrossel-2').click(function() {
                $(".slider-main-2").slick('slickPrev');
            });
